...
class classicwrforum_to_xhtml  extends WikiRendererConfig  {
  /**
    * @var array   liste des tags inline
   */
   public $inlinetags= array( 'cwrxhtml_strong','cwrxhtml_em','cwrxhtml_code','cwrxhtml_q',
    'cwrxhtml_cite','cwrxhtml_acronym','cwrxhtml_link', 'cwrxhtml_image');
   ...
   */
   public $bloctags = array('cwrxhtml_title', 'cwrxhtml_list', 'cwrxhtml_pre',
                         'cwrxhtml_blockquote','cwrxhtml_definition','cwrxhtml_p');


   public $simpletags = array('%%%'=>'<br />', ':-)'=>'<img src="/forums/smileys/smilie1.gif" alt=":-)" />');
