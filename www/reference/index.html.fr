...
<div id="top-box">
        ...
        <div id="lang-box">
          <a href="index.html.en" hreflang="en">en</a>
          <strong>fr</strong>
        </div>
</div>

  <h1 id="logo"><a href="/" title="retour à l'accueil"><img src="/design/logo/logo_jelix_moyen2.png" alt="Jelix" /></a><br/>
  Framework PHP5
  </h1>
...
<ul id="topmenubar">
    ...
    <li><a href="http://developer.jelix.org/wiki/fr">Contribuer</a></li>
</ul>
<ul id="submenubar">
    <li><a href="/articles/fr/tutoriels">Tutoriels</a></li>
    <li><a href="http://docs.jelix.org/fr/manuel-1.4">Manuel 1.4</a></li>
...
<div id="main">
    ...
    <dl>
        ...
        <dt>Dernière version stable Jelix 1.4.1 :</dt>
        <dd><a href="1.4.1/">HTML, en ligne</a> -
        ...
        <dt>Dernière version stable Jelix 1.3.4 :</dt>
        <dd><a href="1.3.4/">HTML, en ligne</a> -
        ...
        <dt>Dernière version stable Jelix 1.2.10 :</dt>
        <dd><a href="1.2.10/">HTML, en ligne</a> -
        ...
        <dt>Dernière version stable Jelix 1.1.12 :</dt>
        <dd> <a href="1.1.12/">HTML, en ligne</a> - 
        ...
        <dt>Dernière version stable Jelix 1.0.14 :</dt>
        <dd> <a href="1.0.14/">HTML, en ligne</a> - 
